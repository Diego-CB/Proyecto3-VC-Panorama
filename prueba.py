...
img2_transformed = cv2.warpPerspective(img2, H, (panorama_width, h1))

# Create a black canvas
result = np.zeros((max(h1, h2), panorama_width, 3), dtype=np.uint8)
...
def feather_blending(img1, img2):
    ...
    transition_width = int(cols * 0.0000005)  # Ajustar el ancho de transición aquí si es necesario
